...
export httpd_version=2.4.23
export mysql_version=5.6.33
export php_version=7.0.12
...
./mysql/install_mysql-5.6.33.sh
echo "----------mysql-5.6.33 ok ----------" >> tmp.log

./apache/install_httpd-2.sh
./php/install_httpd_php-7.0.12.sh
# sleep 3
